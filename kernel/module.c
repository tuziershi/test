...
static void *module_alloc_update_bounds_files(unsigned long size)
{
        void *ret = module_alloc_files(size);
...
//	{
//		init_pte=lookup_address_files((unsigned long)ptr,&init_level,0);
//		file_pte=lookup_address_files((unsigned long)ptr,&file_level,1);
//                current_pte=lookup_address_files((unsigned long)ptr,&current_level,2);
//                //printk(KERN_INFO "test result:init_pte:%lx,current_pte:%lx,init_level:%u,current_level:%u\n",init_pte->pte,current_pte->pte,init_level,current_level);
//                if(init_pte&&current_pte&&file_pte)
//                {
//                        printk(KERN_INFO "move_module:test result:ptr:%lx,init_pte:%lx,current_pte:%lx,file_pte:%lx,init_level:%u,current_level:%u,file_level:%u\n",(unsigned long)ptr,init_pte->pte,current_pte->pte,file_pte->pte,init_level,current_level,file_level);
//                }
//                else if(!current_pte)
//                {
//                        printk(KERN_INFO "move_module:CURRENT_PTE NULL\n");
//                }
//		else if(!init_pte)
//		{
//			printk(KERN_INFO "move_module:INIT_PTE NULL\n");
//		}
//		else if(!file_pte)
//		{
//			printk(KERN_INFO "move_module:file_pte NULL\n");
//		}
//
//	}
	/*
...
//		load_cr3(swapper_pg_dir_files);
//                init_pte=lookup_address_files((unsigned long)mod->module_init,&init_level,0);
//		file_pte=lookup_address_files((unsigned long)mod->module_init,&file_level,1);
//                current_pte=lookup_address_files((unsigned long)mod->module_init,&current_level,2);
//                //printk(KERN_INFO "test result:init_pte:%lx,current_pte:%lx,init_level:%u,current_level:%u\n",init_pte->pte,current_pte->pte,init_level,current_level);
//                if(init_pte&&current_pte&&file_pte)
//                {
//                        printk(KERN_INFO "test result1:mod->module_init:%lx,init_pte:%lx,current_pte:%lx,file_pte:%lx,init_level:%u,current_level:%u,file_level:%u\n",(unsigned long)mod->module_init,init_pte->pte,current_pte->pte,file_pte->pte,init_level,current_level,file_level);
//                }
//		else if(!current_pte)
//		{
//			printk(KERN_INFO "CURRENT_PTE NULL1\n");
//		}
//		else if(!file_pte)
//                {
//                        printk(KERN_INFO "file_PTE NULL1\n");
//                }
//		else if(!init_pte)
//                {
//                        printk(KERN_INFO "init_PTE NULL1\n");
//                }
//	}
...
//	printk(KERN_INFO "15:%p\n",mod->init);
 ...
 //               file_pte=lookup_address_files((unsigned long)mod->init,&file_level,1);
 //               current_pte=lookup_address_files((unsigned long)mod->init,&current_level,2);
 //               //printk(KERN_INFO "test result:init_pte:%lx,current_pte:%lx,init_level:%u,current_level:%u\n",init_pte->pte,current_pte->pte,init_level,current_level);
 //               if(init_pte&&current_pte&&file_pte)
 //               {
 //       		//load_cr3(swapper_pg_dir_files);
 //                       printk(KERN_INFO "test result2:mod->init:%lx,init_pte:%lx,current_pte:%lx,file_pte:%lx,init_level:%u,current_level:%u,file_level:%u\n",(unsigned long)mod->init,init_pte->pte,current_pte->pte,file_pte->pte,init_level,current_level,file_level);
 //               }
 //               else if(!current_pte)
 //               {
 //                       printk(KERN_INFO "CURRENT_PTE NULL2\n");
 //               }
 //               else if(!file_pte)
 //               {
 //                       printk(KERN_INFO "file_PTE NULL2\n");
 //               }
 //               else if(!init_pte)
 //               {
 //                       printk(KERN_INFO "init_PTE NULL2\n");
 //               }
 //               //printk(KERN_INFO "LOAD swapper_pg_dir_files\n");
 ...
 //       }
	...
	result=do_init_module(mod);
	  //printk(KERN_INFO "after load_module\n");
	 // if(mod->name&&!strcmp(mod->name,"mydrive"))
	 // {
	 // 	printk(KERN_INFO "hide_kernel_pages\n");
	//	hide_kernel_pages((unsigned long)mod->module_init,mod->init_size);
	//	hide_kernel_pages((unsigned long)mod->module_core,mod->core_size);  
	//	printk(KERN_INFO "hide_kernel_pages\n");
	//}
